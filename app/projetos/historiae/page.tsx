    ...
    <section>
      <div className="md:mt-8 lg:mt-10 pt-8 pb-16">
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-lg font-semibold mb-4 text-zinc-800 dark:text-zinc-200">Episódios</h2>
            <div className="space-y-4">
              <iframe
                src="https://open.spotify.com/embed/episode/7hZY1vh4f8d0YMgYOdUVZU?utm_source=generator"
                width="100%"
                height="152"
              ...
              />
              <iframe
                src="https://open.spotify.com/embed/episode/3oiCxScQ08snQZ71a0DFKN?utm_source=generator"
                width="100%"
                height="152"
                allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"
                loading="lazy"
